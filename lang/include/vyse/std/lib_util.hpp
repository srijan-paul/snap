...
/// @brief Reports an error and returns false if the native function with name [fname] does not have between
/// [min_args] and [max_args] arguments. When [max_args] is not provided, then it checks if [fname] recieved
/// exactly [min_arg] arguments.
